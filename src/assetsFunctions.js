...
export const OpenSVGLoaderFuncSkrape = () => {
    let svgLoaderDiv = document.createElement("div");
    svgLoaderDiv.setAttribute("id", "skrape-svg-loader-container");
...
export const RemoveSVGLoaderFuncSkrape = () => {
    if (document.body.contains(document.getElementById('skrape-svg-loader-container'))) {
        document.getElementById('skrape-svg-loader-container').remove();
    }
}